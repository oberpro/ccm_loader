            ...
            this.ready = function (callback) {
                ...
                function uniformData() {
                    ...
                    my.questions.map(function (question, i) {
                        ...
                        question.nr = i + 1;
                        question.id = 'question-' + question.nr;
                        ...
                        question.answers.map(function (answer, i) {
                            ...
                            answer.nr = i + 1;
                            answer.class = 'answer-' + answer.nr;
                            answer.id = question.id + '-' + answer.class;
            ...
            this.start = function (callback) {
                ...
                function start() {
                    ...
                    function renderQuestion(question, i) {
                        ...
                        function renderAnswer(answer) {
                            ...
                            function addInput() {
                                ...
                                if (question.input === 'radio') {
                                    input_html.name = question.id;
                                    input_html.value = answer.nr - 1;
                                }
                                ...
                                var input_elem = self.ccm.helper.html({
                                    class: 'input',
                                    inner: input_html
                                });
                    ...
                    function showQuestion() {
                        ...
                        self.ccm.helper.makeIterable(main_elem.querySelectorAll('.question')).map(function (question_elem) {
                            question_elem.style.display = 'none';
                        });
                    ...
                    function updateButtons() {
                        ...
                        function previousQuestion() {
                            ...
                            // prepare event data
                            var event_data = {
                                question_nr: question.i + 1,
                                original_nr: question.nr,
                                number_of_questions: my.questions.length
                            };
                    ...
                    function evaluate(question) {
                        ...
                        self.ccm.helper.makeIterable(question.elem.querySelectorAll('input')).map(function (input_field) {
                    ...
                    function onFinish() {
                        ...
                        if (self.user) self.user.login(proceed);
                        else proceed();
